package com.example.pp_3_1_3_bootstrap.exception_handling;
...
@ControllerAdvice
public class UserClobalExceptionHandler {

    @ExceptionHandler
    public ResponseEntity<UserIncorrectData> handleException(NuSuchUserException exception) {
